...
export function LandingPage({ onLogin, workerSession, callEnabled, onCallEnabled, onCallDisabled, videoEnabled, onVideoEnabledChange }) {
  ...
  const { connected, connecting, videoTrack, micMuted, needsAudioResume,
    preUnlockAudio, resumeAudio, toggleMute, interrupt, audioElRef } = workerSession || {};
      ...
      <div className="hp-badge-group" ref={badgeGroupRef}>
        ...
        <div className={`hp-badge ${callEnabled && connected ? 'hp-badge--video' : ''}`}>
          ...
          <div
            ...
            onClick={!callEnabled ? () => { preUnlockAudio?.(); onCallEnabled?.(); } : undefined}
          ...
          >
            {!callEnabled && (
              <div className="hp-photo-call-btn-wrap">
                ...
                <button className="glass-btn" onClick={e => { e.stopPropagation(); preUnlockAudio?.(); onCallEnabled?.(); }} aria-label="Start call">
                  <span>
